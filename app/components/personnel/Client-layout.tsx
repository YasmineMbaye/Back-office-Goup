...
export default function ClientLayout({ title, role }: DashboardLayoutProps){
    ...
    return(
      <ErrorBoundary>
        ...
        <thead className=" bg-gray-200 font-bold">
            ...
            <th className=" px-4 py-2 text-left">Trajets effectués</th>
            <th className=" px-4 py-2 text-left">Status</th>
          <th className=" px-4 py-2 text-left  " colSpan={2}>Action</th>
          </tr>
        ...
        <tbody>
          <tr className="bg-white hover:bg-gray-50 cursor-pointer border border-gray-200 text-gray-600"
           ...
           <td className=" px-4 py-2">Mamadou </td>
            <td className=" px-4 py-2">  mamadou@email.com</td>
          ...
          {/* <td className="   "><button className="bg-blue-500 text-white p-1 rounded">Voir Details</button> </td>
          */}
          <td className="   "> <button className="bg-blue-500 text-white p-1 rounded "  onClick={ouvrirModal}> Changer Statut</button> </td>
          ...
          >
            ...
            <td className=" px-4 py-2">modou@email.com</td>
             <td className=" px-4 py-2">120</td>
            <td className=" px-4 py-2  "><div className="bg-red-600 text-white w-15 rounded-2xl px-2">Banni </div></td>
          {/*  <td className="   "><button className="bg-blue-500 text-white p-1 rounded">Voir Details</button> </td>
          */}
          <td className="   "> <button className="bg-blue-500 text-white p-1 rounded" onClick={ouvrirModal}> Changer Statut</button> </td>
          ...
          >
            <td className=" px-4 py-2 text-black font-bold">2</td>
            <td className=" px-4 py-2"> Fatima Sene</td>
            <td className=" px-4 py-2">sene@email.com</td>
            <td className=" px-4 py-2">20</td>
            <td className=" px-4 py-2  "><div className="bg-blue-700 text-white w-25 rounded-2xl px-2">En attente </div></td>
        {/*    <td className="   "><button className="bg-blue-500 text-white p-1 rounded">Voir Details</button> </td>
          */}
          <td className="   "> <button className="bg-blue-500 text-white p-1 rounded" onClick={ouvrirModal}> Changer Statut</button> </td>
        ...
        <div className="  flex justify-center items-center h-screen">
          ...
          <div className="bg-gray-100 px-6 py-4 border-b border-gray-200 flex items-center justify-between">
            <h3 className="flex items-center gap-2 text-lg font-semibold text-gray-800">
              <Plus /> Changer le statut du client
            </h3>
            <button
              type="button"
            ...
            <div>
              ...
              <div className="flex gap-6">
                <label className="flex items-center gap-2 text-gray-700">
                  <input type="radio" name="etat" value="Actif" defaultChecked/>
                  Actif
                </label>
                <label className="flex items-center gap-2 text-gray-700">
                  <input type="radio" name="etat" value="Inactif"  />
                  Banni
                </label>
                <label className="flex items-center gap-2 text-gray-700">
                  <input type="radio" name="etat" value="Inactif"  />
