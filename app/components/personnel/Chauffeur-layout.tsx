...
export default function ChauffeurpersLayout({ title, role }: DashboardLayoutProps){
      ...
      <ErrorBoundary>
        ...
        <tbody>
          ...
          >
            ...
            <td className=" px-4 py-2  "><div className="bg-red-600 text-white w-22 rounded-2xl px-2">Suspendu </div></td>
          ...
          >
            ...
            <td className=" px-4 py-2  "><div className="bg-blue-700 text-white w-25 rounded-2xl px-2">En mission </div></td>
          <td className="   "> <button className="bg-blue-500 text-white p-1 rounded" onClick={ouvrirModal}> Changer Statut</button> </td>
        ...
        <div className="  flex justify-center items-center h-screen">
          ...
          <div className="bg-gray-100 px-6 py-4 border-b border-gray-200 flex items-center justify-between">
            <h3 className="flex items-center gap-2 text-lg font-semibold text-gray-800">
              <Plus /> Changer le statut du chauffeur
            </h3>
            <button
              type="button"
