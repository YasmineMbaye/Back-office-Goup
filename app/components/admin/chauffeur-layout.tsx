...
export default function ChauffeurLayout({ title, role }: DashboardLayoutProps){
    ...
    return(
      <ErrorBoundary>
                ...
                <div className="flex justify-between ">
                  <div className=" flex border border-gray-200 rounded">
                   ...
                   <div className=" bg-black text-white px-2  flex items-center rounded cursor-pointer">
                      ...
                      <button onClick={ouvrirModal} > <div className="flex cursor-pointer "><div><Plus className="" /></div>  <div> Ajouter un Chauffeur</div></div> </button>
        ...
        <thead className=" bg-gray-200 font-bold">
            ...
            <th className=" px-4 py-2 text-left ">Trajets réalisés</th>
        ...
        <tbody>
          <tr className="bg-white hover:bg-gray-50 cursor-pointer border border-gray-200 text-gray-600"
           ...
           <td className=" px-4 py-2">Mamadou </td>
            ...
            <td className=" px-4 py-1 line-clamp-1"> 200 </td>
          ...
          >
            ...
            <td className=" px-4 py-1 line-clamp-1">120</td>
