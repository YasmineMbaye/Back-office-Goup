...
export default function PersonnelLayout({ title, role }: DashboardLayoutProps){
      ...
      <ErrorBoundary>
                ...
                <div className="flex justify-between ">
                  <div className=" flex border border-gray-200 rounded">
                   ...
                   <div className=" bg-black text-white px-2  flex items-center rounded cursor-pointer">
                      ...
                      <button onClick={ouvrirModal} > <div className="flex cursor-pointer "><div><Plus className="" /></div>  <div> Ajouter un personnel</div></div> </button>
        ...
        <tbody>
          ...
          >
            ...
            <td className=" px-4 py-1 line-clamp-1">Comptable  SecretaireSecretaire</td>
          ...
          >
            <td className=" px-4 py-2 text-black font-bold">2</td>
            <td className=" px-4 py-2">Boubacar</td>
            <td className=" px-4 py-2">Diatta</td>
            <td className=" px-4 py-1 line-clamp-1">Personnel  SecretaireSecretaire</td>
             <td className=" px-4 py-2 "> <div className="bg-green-600 text-white w-13 rounded-2xl px-2">actif </div></td>
              </tr>
        </tbody>
      </table>
