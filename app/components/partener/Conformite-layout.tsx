...
export default function ConformiteLayout({ title, role }: DashboardLayoutProps){
    ...
    return(
      <ErrorBoundary>
        ...
        <thead className=" bg-gray-200 font-bold">
            ...
            <th className=" px-4 py-2 text-left">Nom / Référence</th>
            <th className=" px-4 py-2 text-left  ">Région</th>
            <th className=" px-4 py-2 text-left  ">Dernière vérification</th>
        ...
        <tbody>
          <tr className="bg-white hover:bg-gray-50 cursor-pointer border border-gray-200 text-gray-600"
           ...
           <td className=" px-4 py-2"> Chauffeur </td>
            <td className=" px-4 py-2"> Mamadou Ndiaye</td>
            <td className=" px-4 py-2">GoUp-Sénégal</td>
            <td className=" px-4 py-2"> 28 Oct 2025</td>
            <td className=" px-4 py-2 "> <div className="bg-green-600 text-white w-23 rounded-2xl px-2">Conforme </div></td>
          </tr>
          ...
          >
            ...
            <td className=" px-4 py-2">Samba Ndiaye</td>
            <td className=" px-4 py-1 ">GoUp-Mali</td>
            <td className=" px-4 py-1 ">27 Oct 2025</td>
            <td className=" px-4 py-2  "><div className="bg-green-600 text-white w-32 rounded-2xl px-2">Non conforme</div></td>
          </tr>

           <tr className="bg-white hover:bg-gray-50 cursor-pointer border border-gray-300 text-gray-600 "
          
          >
            <td className=" px-4 py-2 text-black font-bold">3</td>
            <td className=" px-4 py-2">Trajet</td>
            <td className=" px-4 py-2">#201 Dakar→Yoff</td>
            <td className=" px-4 py-1 ">Sénégal</td>
            <td className=" px-4 py-1 ">29 Oct 2025</td>
             <td className=" px-4 py-2 "> <div className="bg-green-600 text-white w-23 rounded-2xl px-2">Conforme </div></td>
              </tr>
        </tbody>
      </table>
