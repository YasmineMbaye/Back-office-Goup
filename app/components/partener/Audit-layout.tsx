...
export default function AuditLayout({ title, role }: DashboardLayoutProps){
      ...
      <ErrorBoundary>
        ...
        <tbody>
          <tr className="bg-white hover:bg-gray-50 cursor-pointer border border-gray-200 text-gray-600"
           ...
           <td className=" px-4 py-2"> Go-up Sénégal </td>
            <td className=" px-4 py-2"> Trajets du mois</td>
            <td className=" px-4 py-2"> Fatou </td>
            <td className=" px-4 py-2"> 28 Oct 2025</td>
            <td className=" px-4 py-2 "> <div className="bg-green-600 text-white w-20 rounded-2xl px-2">Terminé </div></td>
          </tr>
          ...
          >
            ...
            <td className=" px-4 py-2">Paiements et facturation</td>
            <td className=" px-4 py-1 ">Mamadou</td>
            <td className=" px-4 py-1 ">27 Oct 2025</td>
            <td className=" px-4 py-2  "><div className="bg-green-600 text-white w-22 rounded-2xl px-2">En cours</div></td>
          </tr>
          ...
          >
            ...
            <td className=" px-4 py-2">Go-up Niger</td>
            <td className=" px-4 py-2">Conformité chauffeurs</td>
            <td className=" px-4 py-1 ">Aissatou</td>
            <td className=" px-4 py-1 ">29 Oct 2025</td>
             <td className=" px-4 py-2 "> <div className="bg-green-600 text-white w-20 rounded-2xl px-2">Planifié </div></td>
              </tr>
        </tbody>
      </table>
